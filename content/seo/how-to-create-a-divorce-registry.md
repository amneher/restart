...
Here's where it gets practical. From any online retailer — Amazon, Target, Wayfair, Crate & Barrel, wherever you shop — find a product you want and copy the URL. Paste it into your registry, and reStart pulls in the product name, image, and price automatically. Add a quantity if you want more than one, and an optional note if there's context that would help ("This replaces the one we split — finally getting my own").
