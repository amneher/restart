...
add_filter(
    'login_url', function (string $url, string $redirect, bool $force_reauth): string {
...
add_filter(
    'logout_redirect', function (): string {
        return home_url('/');
    }
);
...
add_filter(
    'login_redirect', function (string $redirect_to, string $requested, $user): string {
...
add_filter(
    'authenticate', function ($user, string $username, string $password) {
...
add_action(
    'wp_ajax_restart_deactivate_account', function (): void {
...
add_action(
    'wp_ajax_restart_delete_account', function (): void {
...
add_action(
    'wp_ajax_nopriv_restart_register', function (): void {
...
add_action(
    'wp_ajax_restart_update_profile', function (): void {
