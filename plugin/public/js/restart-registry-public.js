...
(function () {
    ...
    function updateItemCount()
    {
        ...
        document.querySelectorAll('.rr-item-count').forEach(
            function (el) {
    ...
    if (publicHelpToggle) {
        publicHelpToggle.addEventListener(
            'click', function () {
    ...
    if (copyLink) {
        copyLink.addEventListener(
            'click', function () {
                var btn = this;
                navigator.clipboard.writeText(document.getElementById('rr-share-url').value).then(
                    function () {
    ...
    if (archiveConfirmBtn) {
        archiveConfirmBtn.addEventListener(
            'click', function () {
                var btn = this;
                btn.disabled = true;
    ...
    if (deleteRegistryBtn) {
        deleteRegistryBtn.addEventListener(
            'click', function () {
                closeModal('#rr-settings-modal');
    ...
    if (deleteUnderstand) {
        deleteUnderstand.addEventListener(
            'change', function () {
    ...
    if (editRegistryForm) {
        editRegistryForm.addEventListener(
            'submit', function (e) {
                e.preventDefault();
    ...
    if (sendInviteForm) {
        sendInviteForm.addEventListener(
            'submit', function (e) {
                e.preventDefault();
