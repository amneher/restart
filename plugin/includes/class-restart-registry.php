...
class Restart_Registry
{
    ...
    {
        include_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-restart-registry-loader.php';
        include_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-restart-registry-i18n.php';
        include_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-affiliate-converter.php';
        include_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-restart-registry-controller.php';
        include_once plugin_dir_path(dirname(__FILE__)) . 'admin/class-restart-registry-admin.php';
        include_once plugin_dir_path(dirname(__FILE__)) . 'public/class-restart-registry-public.php';
    ...
    {
        add_filter(
            'restart_registry_affiliate_configs', function (array $configs): array {
    ...
    private function define_role_hooks(): void
    {
        ...
        add_filter(
            'show_admin_bar', function (bool $show): bool {
